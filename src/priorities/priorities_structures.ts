...
export const AttackStructureScores = _.fromPairs(
	_.map(AttackStructurePriorities, type => [
		type,
		AttackStructurePriorities.length - _.indexOf(AttackStructurePriorities, type)
	])
 ...
 */
export const DemolishStructurePriorities: Array<{
