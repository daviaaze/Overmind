...
export class Matcher {
	men: string[];
	women: string[];
	menFree: Record<string, boolean>;
	womenFree: Record<string, boolean>;
	menPrefs: Record<string, string[]>;
	womenPrefs: Record<string, string[]>;
	couples: Record<string, string>;

	constructor(menPrefs: Record<string, string[]>, womenPrefs: Record<string, string[]>) {
