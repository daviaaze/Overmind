...
Object.defineProperty(Room.prototype, "owner", {
	get() {
		return this.controller?.owner ? this.controller.owner.username : undefined;
	},
	configurable: true
});
...
Object.defineProperty(Room.prototype, "reservedByMe", {
	get() {
		return this.controller?.reservation && this.controller.reservation.username == MY_USERNAME;
	},
	configurable: true
});
...
Object.defineProperty(Room.prototype, "signedByMe", {
	get() {
		return this.controller?.sign && this.controller.sign.text == Memory.settings.signature;
	},
	configurable: true
});
	...
	get() {
		if (!this._fleeDefaults) {
			this._fleeDefaults = ([] as HasPos[])
				...
				.concat(_.filter(this.keeperLairs, (l: StructureKeeperLair) => (l.ticksToSpawn || Infinity) <= 10));
		}
