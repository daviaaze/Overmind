...
RoomPosition.prototype.findClosestByLimitedRange = function <T>(
  objects: T[] | RoomPosition[],
  rangeLimit: number,
): T | undefined {
  const objectsInRange = this.findInRange(objects, rangeLimit)
