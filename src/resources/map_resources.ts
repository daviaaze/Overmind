...
export const REAGENTS: Record<string, [ResourceConstant, ResourceConstant]> = {
  // Tier 3
  [RESOURCE_CATALYZED_GHODIUM_ALKALIDE]: [
    RESOURCE_GHODIUM_ALKALIDE,
    RESOURCE_CATALYST
...
export const boostParts: Record<string, BodyPartConstant> = {
  UH: ATTACK,
  UO: WORK,
  KH: CARRY,
  KO: RANGED_ATTACK,
...
export const boostResources: Record<string, Record<number, _ResourceConstantSansEnergy>> = {
  attack: {
    1: 'UH',
    2: 'UH2O',
    3: 'XUH2O'
