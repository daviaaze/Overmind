...
export function initializeTask (protoTask: ProtoTask): Task {
  ...
  switch (taskName) {
    ...
    case goToRoomTaskName:
      task = new TaskGoToRoom(
        protoTask._target._pos.roomName
      )
      break
