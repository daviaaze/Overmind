...
import { type attackTargetType, TaskAttack } from "./instances/attack";
import { type buildTargetType, TaskBuild } from "./instances/build";
import { type claimTargetType, TaskClaim } from "./instances/claim";
import { type dismantleTargetType, TaskDismantle } from "./instances/dismantle";
import { type dropTargetType, TaskDrop } from "./instances/drop";
// import {fleeTargetType, TaskFlee} from './instances/flee';
import { type fortifyTargetType, TaskFortify } from "./instances/fortify";
import { type getBoostedTargetType, TaskGetBoosted } from "./instances/getBoosted";
import { type getRenewedTargetType, TaskGetRenewed } from "./instances/getRenewed";
import { type goToRoomTargetType, TaskGoToRoom } from "./instances/goToRoom";
import { type harvestTargetType, TaskHarvest } from "./instances/harvest";
import { type healTargetType, TaskHeal } from "./instances/heal";
import { type meleeAttackTargetType, TaskMeleeAttack } from "./instances/meleeAttack";
import { type pickupTargetType, TaskPickup } from "./instances/pickup";
import { type rangedAttackTargetType, TaskRangedAttack } from "./instances/rangedAttack";
import { TaskRecharge } from "./instances/recharge";
import { type repairTargetType, TaskRepair } from "./instances/repair";
import { type reserveTargetType, TaskReserve } from "./instances/reserve";
import { type signControllerTargetType, TaskSignController } from "./instances/signController";
import { TaskTransfer, type transferTargetType } from "./instances/transfer";
import { TaskTransferAll, type transferAllTargetType } from "./instances/transferAll";
import { TaskUpgrade, type upgradeTargetType } from "./instances/upgrade";
import { TaskWithdraw, type withdrawTargetType } from "./instances/withdraw";
import { TaskWithdrawAll, type withdrawAllTargetType } from "./instances/withdrawAll";
...
export class Tasks {
	...
	static signController(target: signControllerTargetType, options = {} as TaskOptions): TaskSignController {
	...
	static transferAll(target: transferAllTargetType, skipEnergy = false, options = {} as TaskOptions): TaskTransferAll {
