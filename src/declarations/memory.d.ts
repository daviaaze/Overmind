...
interface Memory {
	...
	profiler?: any;
	stats: any;
	constructionSites: Record<string, number>;
	// suspend?: number;
	resetBucket?: boolean;
	haltTick?: number;
	combatPlanner: any;
...
interface PathingMemory {
	paths: Record<string, Record<string, CachedPath>>;
	distances: Record<string, Record<string, number>>;
	weightedDistances: Record<string, Record<string, number>>;
}
...
interface RoomMemory {
	...
	[_RM.PREV_POSITIONS]?: Record<string, ProtoPos>;
	[_RM.CREEPS_IN_ROOM]?: Record<number, string[]>;
}
