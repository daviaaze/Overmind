...
interface IGlobalCache {
	...
	roomPositions: Record<string, RoomPosition | undefined>;
	things: Record<string, undefined | HasID | HasID[]>;
	// objects: { [key: string]: Object };
}

interface ICache {
	overlords: Record<string, Record<string, string[]>>;
...
interface IOvermind {
	...
	directives: Record<string, any>; // is actually { [flagName: string]: Directive }
	zerg: Record<string, any>; // is actually { [creepName: string]: Zerg }
	colonies: Record<string, any>; // is actually { [roomName: string]: Colony }
	overlords: Record<string, any>; // is actually { [ref: string]: Overlord }
	spawnGroups: Record<string, any>; // is actually { [ref: string]: SpawnGroup }
	colonyMap: Record<string, string>;
...
declare let Overmind: IOvermind;
