 ...
 */
export function toColumns(obj: Record<string, string>, opts = {} as ToColumnOpts): string[] {
	_.defaults(opts, {
	...
	for (const key in obj) {
		if (opts.justify) {
			ret.push(key.padRight(keyPadding, opts.padChar) + obj[key].padStart(valPadding, opts.padChar));
		} else {
